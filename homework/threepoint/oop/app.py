...
def console():
    while True:
        ...
        standard_deviation_tasks.append(task.calculate_task_standard_deviation())
        print('SD(task) (standard deviation for each task):', standard_deviation_tasks)
        ...
        if answer != "y":
            ...
            print(f"E(project)(expected value for project): {expected_value_project}")

            standard_error_project = project.calculate_standard_error_project()
            print(f"SE(project)(standard error for project): {standard_error_project}")

            confidence_interval_project = project.calculate_confidence_interval(expected_value_project,
